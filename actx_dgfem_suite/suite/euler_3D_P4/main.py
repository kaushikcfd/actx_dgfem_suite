...
def _rhs_inner(
    ...
    *,
    ...
    _pt_t_unit = make_loopy_program(
        "{ [_0, _1] : 0 <= _0 <= 187199 and 0 <= _1 <= 14 }",
        "out[_0, _1] = in_0[in_1[_0] % 4, _1]",
        [
            lp.GlobalArg("out", dtype=np.int32, shape=(187200, 15)),
            lp.GlobalArg("in_0", dtype=np.int32, shape=(4, 15)),
            lp.GlobalArg("in_1", dtype=np.int8, shape=(187200,)),
        ],
    )
    _pt_t_unit_0 = make_loopy_program(
        ...
        [
            lp.GlobalArg("out", dtype=np.float64, shape=(187200, 15)),
            lp.GlobalArg("in_0", dtype=np.float64, shape=(48000, 35)),
            lp.GlobalArg("in_1", dtype=np.int32, shape=(187200, 1)),
            lp.GlobalArg("in_2", dtype=np.int32, shape=(187200, 15)),
        ],
    )
    ...
    _pt_t_unit_10 = make_loopy_program(
        "{ [_0, _1] : 0 <= _0 <= 4799 and 0 <= _1 <= 14 }",
        "out[_0, _1] = _in0[_0, 0]*_in1[_0, _1]",
        [
            lp.GlobalArg("out", dtype=np.float64, shape=(4800, 15)),
            lp.GlobalArg("_in0", dtype=np.float64, shape=(4800, 1)),
            lp.GlobalArg("_in1", dtype=np.float64, shape=(4800, 15)),
        ],
    )
    _pt_t_unit_11 = make_loopy_program(
        "{ [_0, _1] : 0 <= _0 <= 191999 and 0 <= _1 <= 14 }",
        "out[_0, _1] = in_0[in_1[_0, 0] % 4800, in_2[_0, _1] % 15]",
        [
            lp.GlobalArg("out", dtype=np.float64, shape=(192000, 15)),
            lp.GlobalArg("in_0", dtype=np.float64, shape=(4800, 15)),
    ...
    _pt_t_unit_2 = make_loopy_program(
        "{ [_0, _1] : 0 <= _0 <= 187199 and 0 <= _1 <= 14 }",
        "out[_0, _1] = in_0[in_1[_0, 0] % 187200, in_2[_0, _1] % 15]",
        [
            lp.GlobalArg("out", dtype=np.float64, shape=(187200, 15)),
            lp.GlobalArg("in_0", dtype=np.float64, shape=(187200, 15)),
            lp.GlobalArg("in_1", dtype=np.int32, shape=(187200, 1)),
            lp.GlobalArg("in_2", dtype=np.int32, shape=(187200, 15)),
        ],
    )
    _pt_t_unit_3 = make_loopy_program(
        ...
        [
            lp.GlobalArg("out", dtype=np.float64, shape=(187200, 15)),
            lp.GlobalArg("_in0", dtype=np.float64, shape=(187200, 15)),
            lp.GlobalArg("_in1", dtype=np.float64, shape=(187200, 1)),
        ],
    )
    _pt_t_unit_4 = make_loopy_program(
        ...
        [
            ...
            lp.GlobalArg("in_1", dtype=np.int32, shape=(192000,)),
        ],
    )
    ...
    _pt_t_unit_6 = make_loopy_program(
        ...
        [
            lp.GlobalArg("out", dtype=np.float64, shape=(192000, 15)),
            lp.GlobalArg("_in0", dtype=np.int8, shape=(192000, 1)),
            lp.GlobalArg("_in1", dtype=np.float64, shape=(192000, 15)),
        ],
    )
    _pt_t_unit_7 = make_loopy_program(
        ...
        "out[_0, _1] = in_0[in_1[_0] % 4, _1]",
        [
            lp.GlobalArg("out", dtype=np.int32, shape=(4800, 15)),
            lp.GlobalArg("in_0", dtype=np.int32, shape=(4, 15)),
            lp.GlobalArg("in_1", dtype=np.int8, shape=(4800,)),
        ],
    )
    _pt_t_unit_8 = make_loopy_program(
        ...
        [
            lp.GlobalArg("out", dtype=np.float64, shape=(4800, 15)),
            lp.GlobalArg("in_0", dtype=np.float64, shape=(48000, 35)),
            lp.GlobalArg("in_1", dtype=np.int32, shape=(4800, 1)),
            lp.GlobalArg("in_2", dtype=np.int32, shape=(4800, 15)),
        ],
    )
    _pt_t_unit_9 = make_loopy_program(
        ...
        [
            lp.GlobalArg("out", dtype=np.float64, shape=(4800, 15)),
            lp.GlobalArg("_in0", dtype=np.float64, shape=(4800, 15)),
            lp.GlobalArg("_in1", dtype=np.float64, shape=(4800, 1)),
        ],
    )
    ...
    _pt_tmp_25 = actx.np.reshape(_pt_data_4, (4, 48000, 1))
    ...
    _pt_tmp_31 = actx.np.reshape(_pt_data_5, (192000, 1))
    ...
    _pt_tmp_43 = actx.np.reshape(_pt_data_6, (187200, 1))
    ...
    _pt_tmp_69 = actx.np.reshape(_pt_data_9, (187200, 1))
    ...
    _pt_tmp_139 = actx.np.reshape(_pt_data_15, (192000, 1))
    ...
    _pt_tmp_145 = actx.np.reshape(_pt_data_17, (192000, 1))
    ...
    _pt_tmp_157 = actx.np.reshape(_pt_data_18, (4800, 1))
    ...
    _pt_tmp_255 = actx.np.reshape(_pt_data_24, (192000, 1))
    ...
    del _pt_tmp_143
    _pt_tmp_26 = actx.np.reshape(_pt_tmp_27, (4, 48000, 15))
    ...
    del _pt_tmp_293
    _pt_tmp_262 = actx.np.reshape(_pt_tmp_263, (4, 48000, 15))
    ...
    del _pt_tmp_387
    _pt_tmp_336 = actx.np.reshape(_pt_tmp_337, (4, 48000, 15))
    ...
    del _pt_tmp_495
    _pt_tmp_448 = actx.np.reshape(_pt_tmp_449, (4, 48000, 15))
    ...
    del _pt_tmp_599
    _pt_tmp_552 = actx.np.reshape(_pt_tmp_553, (4, 48000, 15))
