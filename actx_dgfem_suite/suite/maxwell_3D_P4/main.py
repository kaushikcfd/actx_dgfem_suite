...
def _rhs_inner(
    ...
    *,
    ...
    _pt_t_unit_3 = make_loopy_program(
        ...
        [
            lp.GlobalArg("out", dtype=np.float64, shape=(367500, 15)),
            lp.GlobalArg("_in0", dtype=np.float64, shape=(367500, 1)),
            lp.GlobalArg("_in1", dtype=np.float64, shape=(367500, 15)),
        ],
    )
    ...
    _pt_tmp_19 = actx.np.reshape(_pt_data_4, (4, 93750, 1))
    ...
    del _pt_tmp_38
    _pt_tmp_41 = actx.np.reshape(_pt_data_10, (367500, 1))
    ...
    del _pt_tmp_28
    _pt_tmp_81 = actx.np.reshape(_pt_data_15, (375000, 1))
    ...
    del _pt_tmp_92
    _pt_tmp_136 = actx.np.reshape(_pt_data_24, (375000, 1))
    _pt_tmp_90 = (
    ...
    del _pt_tmp_88
    _pt_tmp_137 = actx.np.zeros((375000, 15), dtype=np.float64)
    del _pt_tmp_87
    ...
    del _pt_tmp_84
    _pt_tmp_20 = actx.np.reshape(_pt_tmp_21, (4, 93750, 15))
    ...
    del _pt_tmp_176
    _pt_tmp_152 = actx.np.reshape(_pt_tmp_153, (4, 93750, 15))
    ...
    del _pt_tmp_221
    _pt_tmp_209 = actx.np.reshape(_pt_tmp_210, (4, 93750, 15))
    ...
    del _pt_tmp_269
    _pt_tmp_243 = actx.np.reshape(_pt_tmp_244, (4, 93750, 15))
    ...
    del _pt_tmp_324
    _pt_tmp_305 = actx.np.reshape(_pt_tmp_306, (4, 93750, 15))
    ...
    _pt_tmp_353 = actx.np.reshape(_pt_tmp_354, (4, 93750, 15))
...
class RHSInvoker:
    ...
    def npzfile(self):
        ...
        kw_to_ary = np.load(
            os.path.join(
                get_actx_dgfem_suite_path(), "suite/maxwell_3D_P4/literals.npz"
            )
        )
        return constantdict(
            {
    ...
    def _get_output_template(self):
        ...
        fpath = os.path.join(
            get_actx_dgfem_suite_path(), "suite/maxwell_3D_P4/ref_outputs.pkl"
        )
