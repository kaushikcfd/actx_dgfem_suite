...
def _rhs_inner(
    ...
    *,
    ...
    _pt_t_unit_3 = make_loopy_program(
        ...
        [
            lp.GlobalArg("out", dtype=np.float64, shape=(352, 4)),
            lp.GlobalArg("_in0", dtype=np.float64, shape=(352, 1)),
            lp.GlobalArg("_in1", dtype=np.float64, shape=(352, 4)),
        ],
    )
    ...
    _pt_tmp_14 = actx.np.reshape(_pt_data_4, (3, 128, 1))
    ...
    del _pt_tmp_32
    _pt_tmp_35 = actx.np.reshape(_pt_data_10, (352, 1))
    ...
    del _pt_tmp_23
    _pt_tmp_54 = actx.np.reshape(_pt_data_14, (384, 1))
    ...
    del _pt_tmp_65
    _pt_tmp_90 = actx.np.reshape(_pt_data_22, (384, 1))
    _pt_tmp_63 = (
    ...
    del _pt_tmp_61
    _pt_tmp_91 = actx.np.zeros((384, 4), dtype=np.float64)
    del _pt_tmp_60
    ...
    del _pt_tmp_57
    _pt_tmp_15 = actx.np.reshape(_pt_tmp_16, (3, 128, 4))
    ...
    del _pt_tmp_114
    _pt_tmp_103 = actx.np.reshape(_pt_tmp_104, (3, 128, 4))
    ...
    del _pt_tmp_173
    _pt_tmp_136 = actx.np.reshape(_pt_tmp_137, (3, 128, 4))
    ...
    del _pt_tmp_229
    _pt_tmp_212 = actx.np.reshape(_pt_tmp_213, (3, 128, 4))
    ...
    del _pt_tmp_263
    _pt_tmp_253 = actx.np.reshape(_pt_tmp_254, (3, 128, 4))
    ...
    _pt_tmp_283 = actx.np.reshape(_pt_tmp_284, (3, 128, 4))
...
class RHSInvoker:
    ...
    def npzfile(self):
        ...
        kw_to_ary = np.load(
            os.path.join(
                get_actx_dgfem_suite_path(), "suite/tiny_maxwell_2D_P3/literals.npz"
            )
        )
        return constantdict(
            {
    ...
    def _get_output_template(self):
        ...
        fpath = os.path.join(
            get_actx_dgfem_suite_path(), "suite/tiny_maxwell_2D_P3/ref_outputs.pkl"
        )
