...
def _rhs_inner(
    ...
    *,
    ...
    _pt_t_unit_11 = make_loopy_program(
        ...
        "out[_0, _1] = in_0[in_1[_0, 0] % 384, in_2[_0, _1] % 4]",
        [
            lp.GlobalArg("out", dtype=np.complex128, shape=(192, 3)),
            lp.GlobalArg("in_0", dtype=np.complex128, shape=(384, 4)),
            lp.GlobalArg("in_1", dtype=np.int32, shape=(192, 1)),
            lp.GlobalArg("in_2", dtype=np.int64, shape=(192, 3)),
        ],
    )
    _pt_t_unit_12 = make_loopy_program(
        ...
        [
            ...
            lp.GlobalArg("_in1", dtype=np.complex128, shape=(192, 3)),
        ],
    )
    _pt_t_unit_13 = make_loopy_program(
        ...
        [
            lp.GlobalArg("out", dtype=np.complex128, shape=(1536, 3)),
            lp.GlobalArg("in_0", dtype=np.complex128, shape=(192, 3)),
    ...
    _pt_t_unit_14 = make_loopy_program(
        ...
        [
            lp.GlobalArg("out", dtype=np.float64, shape=(1344, 3)),
            lp.GlobalArg("_in0", dtype=np.float64, shape=(1344, 1)),
            lp.GlobalArg("_in1", dtype=np.float64, shape=(1344, 3)),
        ],
    )
    ...
    _pt_t_unit_3 = make_loopy_program(
        ...
        "out[_0, _1] = in_0[in_1[_0, 0] % 384, in_2[_0, _1] % 4]",
        [
            lp.GlobalArg("out", dtype=np.complex128, shape=(1344, 3)),
            lp.GlobalArg("in_0", dtype=np.complex128, shape=(384, 4)),
            lp.GlobalArg("in_1", dtype=np.int32, shape=(1344, 1)),
            lp.GlobalArg("in_2", dtype=np.int64, shape=(1344, 3)),
        ],
    ...
    _pt_t_unit_4 = make_loopy_program(
        ...
        [
            lp.GlobalArg("out", dtype=np.complex128, shape=(1344, 3)),
            lp.GlobalArg("in_0", dtype=np.complex128, shape=(1344, 3)),
            lp.GlobalArg("in_1", dtype=np.int32, shape=(1344, 1)),
            lp.GlobalArg("in_2", dtype=np.int64, shape=(1344, 3)),
        ],
    )
    _pt_t_unit_5 = make_loopy_program(
        ...
        [
            lp.GlobalArg("out", dtype=np.complex128, shape=(1344, 3)),
            lp.GlobalArg("_in0", dtype=np.float64, shape=(1344, 1)),
            lp.GlobalArg("_in1", dtype=np.complex128, shape=(1344, 3)),
        ],
    )
    ...
    _pt_t_unit_8 = make_loopy_program(
        ...
        [
            ...
            lp.GlobalArg("_in1", dtype=np.complex128, shape=(1536, 3)),
        ],
    )
    ...
    _pt_tmp_19 = actx.np.reshape(_pt_data_4, (4, 384, 1))
    ...
    del _pt_tmp_38
    _pt_tmp_41 = actx.np.reshape(_pt_data_10, (1344, 1))
    ...
    del _pt_tmp_28
    _pt_tmp_81 = actx.np.reshape(_pt_data_15, (1536, 1))
    ...
    del _pt_tmp_92
    _pt_tmp_136 = actx.np.reshape(_pt_data_24, (1536, 1))
    _pt_tmp_90 = (
    ...
    del _pt_tmp_88
    _pt_tmp_137 = actx.np.zeros((1536, 3), dtype=np.complex128)
    del _pt_tmp_87
    ...
    del _pt_tmp_84
    _pt_tmp_20 = actx.np.reshape(_pt_tmp_21, (4, 384, 3))
    ...
    del _pt_tmp_176
    _pt_tmp_152 = actx.np.reshape(_pt_tmp_153, (4, 384, 3))
    ...
    del _pt_tmp_221
    _pt_tmp_209 = actx.np.reshape(_pt_tmp_210, (4, 384, 3))
    ...
    del _pt_tmp_269
    _pt_tmp_243 = actx.np.reshape(_pt_tmp_244, (4, 384, 3))
    ...
    del _pt_tmp_324
    _pt_tmp_305 = actx.np.reshape(_pt_tmp_306, (4, 384, 3))
    ...
    _pt_tmp_353 = actx.np.reshape(_pt_tmp_354, (4, 384, 3))
...
class RHSInvoker:
    ...
    def npzfile(self):
        ...
        kw_to_ary = np.load(
            os.path.join(
                get_actx_dgfem_suite_path(), "suite/tiny_maxwell_3D_P1/literals.npz"
            )
        )
        return constantdict(
            {
    ...
    def _get_output_template(self):
        ...
        fpath = os.path.join(
            get_actx_dgfem_suite_path(), "suite/tiny_maxwell_3D_P1/ref_outputs.pkl"
        )
