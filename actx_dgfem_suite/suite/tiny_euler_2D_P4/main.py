...
def _rhs_inner(
    ...
    *,
    ...
    _pt_tmp_21 = actx.np.reshape(_pt_data_4, (3, 72, 1))
    ...
    del _pt_tmp_21
    _pt_tmp_27 = actx.np.reshape(_pt_data_5, (216, 1))
    _pt_data_6 = actx.thaw(npzfile["_pt_data_6"])
    _pt_tmp_38 = actx.np.reshape(_pt_data_6, (192, 1))
    ...
    _pt_tmp_59 = actx.np.reshape(_pt_data_9, (192, 1))
    ...
    _pt_tmp_111 = actx.np.reshape(_pt_data_14, (216, 1))
    ...
    del _pt_tmp_25
    _pt_tmp_116 = actx.np.reshape(_pt_data_17, (216, 1))
    _pt_data_18 = actx.thaw(npzfile["_pt_data_18"])
    _pt_tmp_127 = actx.np.reshape(_pt_data_18, (24, 1))
    ...
    _pt_tmp_199 = actx.np.reshape(_pt_data_22, (216, 1))
    _pt_tmp_117 = (
    ...
    del _pt_tmp_114
    _pt_tmp_22 = actx.np.reshape(_pt_tmp_23, (3, 72, 5))
    ...
    del _pt_tmp_228
    _pt_tmp_205 = actx.np.reshape(_pt_tmp_206, (3, 72, 5))
    ...
    del _pt_tmp_297
    _pt_tmp_260 = actx.np.reshape(_pt_tmp_261, (3, 72, 5))
    ...
    del _pt_tmp_374
    _pt_tmp_341 = actx.np.reshape(_pt_tmp_342, (3, 72, 5))
...
class RHSInvoker:
    ...
    def npzfile(self):
        ...
        kw_to_ary = np.load(
            os.path.join(
                get_actx_dgfem_suite_path(), "suite/tiny_euler_2D_P4/literals.npz"
            )
        )
        return constantdict(
            {
    ...
    def _get_output_template(self):
        ...
        fpath = os.path.join(
            get_actx_dgfem_suite_path(), "suite/tiny_euler_2D_P4/ref_outputs.pkl"
        )
