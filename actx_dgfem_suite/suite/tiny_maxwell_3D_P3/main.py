...
def _rhs_inner(
    ...
    *,
    ...
    _pt_t_unit_11 = make_loopy_program(
        ...
        "out[_0, _1] = in_0[in_1[_0, 0] % 162, in_2[_0, _1] % 20]",
        [
            lp.GlobalArg("out", dtype=np.complex128, shape=(108, 10)),
            lp.GlobalArg("in_0", dtype=np.complex128, shape=(162, 20)),
            lp.GlobalArg("in_1", dtype=np.int32, shape=(108, 1)),
            lp.GlobalArg("in_2", dtype=np.int64, shape=(108, 10)),
        ],
    )
    _pt_t_unit_12 = make_loopy_program(
        ...
        [
            ...
            lp.GlobalArg("_in1", dtype=np.complex128, shape=(108, 10)),
        ],
    )
    _pt_t_unit_13 = make_loopy_program(
        ...
        [
            lp.GlobalArg("out", dtype=np.complex128, shape=(648, 10)),
            lp.GlobalArg("in_0", dtype=np.complex128, shape=(108, 10)),
    ...
    _pt_t_unit_14 = make_loopy_program(
        ...
        [
            ...
            lp.GlobalArg("_in1", dtype=np.float64, shape=(540, 10)),
        ],
    )
    ...
    _pt_t_unit_3 = make_loopy_program(
        ...
        "out[_0, _1] = in_0[in_1[_0, 0] % 162, in_2[_0, _1] % 20]",
        [
            lp.GlobalArg("out", dtype=np.complex128, shape=(540, 10)),
            lp.GlobalArg("in_0", dtype=np.complex128, shape=(162, 20)),
            lp.GlobalArg("in_1", dtype=np.int32, shape=(540, 1)),
            lp.GlobalArg("in_2", dtype=np.int64, shape=(540, 10)),
        ],
    ...
    _pt_t_unit_4 = make_loopy_program(
        ...
        [
            lp.GlobalArg("out", dtype=np.complex128, shape=(540, 10)),
            lp.GlobalArg("in_0", dtype=np.complex128, shape=(540, 10)),
            lp.GlobalArg("in_1", dtype=np.int32, shape=(540, 1)),
            lp.GlobalArg("in_2", dtype=np.int64, shape=(540, 10)),
        ],
    )
    _pt_t_unit_5 = make_loopy_program(
        ...
        [
            lp.GlobalArg("out", dtype=np.complex128, shape=(540, 10)),
            lp.GlobalArg("_in0", dtype=np.float64, shape=(540, 1)),
            lp.GlobalArg("_in1", dtype=np.complex128, shape=(540, 10)),
        ],
    )
    ...
    _pt_t_unit_8 = make_loopy_program(
        ...
        [
            ...
            lp.GlobalArg("_in1", dtype=np.complex128, shape=(648, 10)),
        ],
    )
    ...
    del _pt_tmp_88
    _pt_tmp_137 = actx.np.zeros((648, 10), dtype=np.complex128)
    del _pt_tmp_87
    ...
    del _pt_tmp_84
    _pt_tmp_20 = actx.np.reshape(_pt_tmp_21, (4, 162, 10))
    ...
    del _pt_tmp_176
    _pt_tmp_152 = actx.np.reshape(_pt_tmp_153, (4, 162, 10))
    ...
    del _pt_tmp_221
    _pt_tmp_209 = actx.np.reshape(_pt_tmp_210, (4, 162, 10))
    ...
    del _pt_tmp_269
    _pt_tmp_243 = actx.np.reshape(_pt_tmp_244, (4, 162, 10))
    ...
    del _pt_tmp_324
    _pt_tmp_305 = actx.np.reshape(_pt_tmp_306, (4, 162, 10))
    ...
    _pt_tmp_353 = actx.np.reshape(_pt_tmp_354, (4, 162, 10))
...
class RHSInvoker:
    ...
    def npzfile(self):
        ...
        kw_to_ary = np.load(
            os.path.join(
                get_actx_dgfem_suite_path(), "suite/tiny_maxwell_3D_P3/literals.npz"
            )
        )
        return constantdict(
            {
    ...
    def _get_output_template(self):
        ...
        fpath = os.path.join(
            get_actx_dgfem_suite_path(), "suite/tiny_maxwell_3D_P3/ref_outputs.pkl"
        )
