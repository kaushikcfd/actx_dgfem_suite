...
def _rhs_inner(
    ...
    *,
    ...
    _pt_t_unit = make_loopy_program(
        "{ [_0, _1] : 0 <= _0 <= 1516799 and 0 <= _1 <= 2 }",
        "out[_0, _1] = in_0[in_1[_0] % 4, _1]",
        [
            lp.GlobalArg("out", dtype=np.int32, shape=(1516800, 3)),
            lp.GlobalArg("in_0", dtype=np.int32, shape=(4, 3)),
            lp.GlobalArg("in_1", dtype=np.int8, shape=(1516800,)),
        ],
    )
    _pt_t_unit_0 = make_loopy_program(
        "{ [_0, _1] : 0 <= _0 <= 1516799 and 0 <= _1 <= 2 }",
        "out[_0, _1] = in_0[in_1[_0, 0] % 384000, in_2[_0, _1] % 4]",
        [
            lp.GlobalArg("out", dtype=np.float64, shape=(1516800, 3)),
            lp.GlobalArg("in_0", dtype=np.float64, shape=(384000, 4)),
            lp.GlobalArg("in_1", dtype=np.int32, shape=(1516800, 1)),
            lp.GlobalArg("in_2", dtype=np.int32, shape=(1516800, 3)),
        ],
    )
    ...
    _pt_t_unit_10 = make_loopy_program(
        "{ [_0, _1] : 0 <= _0 <= 19199 and 0 <= _1 <= 2 }",
        "out[_0, _1] = _in0[_0, 0]*_in1[_0, _1]",
        [
            lp.GlobalArg("out", dtype=np.float64, shape=(19200, 3)),
            lp.GlobalArg("_in0", dtype=np.float64, shape=(19200, 1)),
            lp.GlobalArg("_in1", dtype=np.float64, shape=(19200, 3)),
        ],
    )
    _pt_t_unit_11 = make_loopy_program(
        "{ [_0, _1] : 0 <= _0 <= 1535999 and 0 <= _1 <= 2 }",
        "out[_0, _1] = in_0[in_1[_0, 0] % 19200, in_2[_0, _1] % 3]",
        [
            lp.GlobalArg("out", dtype=np.float64, shape=(1536000, 3)),
            lp.GlobalArg("in_0", dtype=np.float64, shape=(19200, 3)),
            lp.GlobalArg("in_1", dtype=np.int32, shape=(1536000, 1)),
            lp.GlobalArg("in_2", dtype=np.int32, shape=(1536000, 3)),
        ],
    )
    _pt_t_unit_2 = make_loopy_program(
        "{ [_0, _1] : 0 <= _0 <= 1516799 and 0 <= _1 <= 2 }",
        "out[_0, _1] = in_0[in_1[_0, 0] % 1516800, in_2[_0, _1] % 3]",
        [
            lp.GlobalArg("out", dtype=np.float64, shape=(1516800, 3)),
            lp.GlobalArg("in_0", dtype=np.float64, shape=(1516800, 3)),
            lp.GlobalArg("in_1", dtype=np.int32, shape=(1516800, 1)),
            lp.GlobalArg("in_2", dtype=np.int32, shape=(1516800, 3)),
        ],
    )
    _pt_t_unit_3 = make_loopy_program(
        ...
        [
            lp.GlobalArg("out", dtype=np.float64, shape=(1516800, 3)),
            lp.GlobalArg("_in0", dtype=np.float64, shape=(1516800, 3)),
            lp.GlobalArg("_in1", dtype=np.float64, shape=(1516800, 1)),
        ],
    )
    _pt_t_unit_4 = make_loopy_program(
        ...
        "out[_0, _1] = in_0[0, _1]",
        [
            lp.GlobalArg("out", dtype=np.int32, shape=(1536000, 3)),
            lp.GlobalArg("in_0", dtype=np.int32, shape=(1, 3)),
            lp.GlobalArg("in_1", dtype=np.int32, shape=(1536000,)),
        ],
    )
    ...
    _pt_t_unit_6 = make_loopy_program(
        ...
        [
            lp.GlobalArg("out", dtype=np.float64, shape=(1536000, 3)),
            lp.GlobalArg("_in0", dtype=np.int8, shape=(1536000, 1)),
            lp.GlobalArg("_in1", dtype=np.float64, shape=(1536000, 3)),
        ],
    )
    _pt_t_unit_7 = make_loopy_program(
        ...
        "out[_0, _1] = in_0[in_1[_0] % 4, _1]",
        [
            lp.GlobalArg("out", dtype=np.int32, shape=(19200, 3)),
            lp.GlobalArg("in_0", dtype=np.int32, shape=(4, 3)),
            lp.GlobalArg("in_1", dtype=np.int8, shape=(19200,)),
        ],
    )
    _pt_t_unit_8 = make_loopy_program(
        ...
        [
            lp.GlobalArg("out", dtype=np.float64, shape=(19200, 3)),
            lp.GlobalArg("in_0", dtype=np.float64, shape=(384000, 4)),
            lp.GlobalArg("in_1", dtype=np.int32, shape=(19200, 1)),
            lp.GlobalArg("in_2", dtype=np.int32, shape=(19200, 3)),
        ],
    )
    _pt_t_unit_9 = make_loopy_program(
        ...
        [
            lp.GlobalArg("out", dtype=np.float64, shape=(19200, 3)),
            lp.GlobalArg("_in0", dtype=np.float64, shape=(19200, 3)),
            lp.GlobalArg("_in1", dtype=np.float64, shape=(19200, 1)),
        ],
    )
    ...
    _pt_tmp_25 = actx.np.reshape(_pt_data_4, (4, 384000, 1))
    ...
    _pt_tmp_31 = actx.np.reshape(_pt_data_5, (1536000, 1))
    ...
    _pt_tmp_43 = actx.np.reshape(_pt_data_6, (1516800, 1))
    ...
    _pt_tmp_69 = actx.np.reshape(_pt_data_9, (1516800, 1))
    ...
    _pt_tmp_139 = actx.np.reshape(_pt_data_15, (1536000, 1))
    ...
    _pt_tmp_141 = actx.np.zeros((1536000,), dtype=np.int32)
    _pt_tmp_140 = (
    ...
    _pt_tmp_145 = actx.np.reshape(_pt_data_17, (1536000, 1))
    ...
    _pt_tmp_157 = actx.np.reshape(_pt_data_18, (19200, 1))
    ...
    _pt_tmp_255 = actx.np.reshape(_pt_data_24, (1536000, 1))
    ...
    del _pt_tmp_143
    _pt_tmp_26 = actx.np.reshape(_pt_tmp_27, (4, 384000, 3))
    ...
    del _pt_tmp_293
    _pt_tmp_262 = actx.np.reshape(_pt_tmp_263, (4, 384000, 3))
    ...
    del _pt_tmp_387
    _pt_tmp_336 = actx.np.reshape(_pt_tmp_337, (4, 384000, 3))
    ...
    del _pt_tmp_495
    _pt_tmp_448 = actx.np.reshape(_pt_tmp_449, (4, 384000, 3))
    ...
    del _pt_tmp_599
    _pt_tmp_552 = actx.np.reshape(_pt_tmp_553, (4, 384000, 3))
