...
def _rhs_inner(
    ...
    *,
    ...
    _pt_t_unit = make_loopy_program(
        "{ [_0, _1] : 0 <= _0 <= 526847 and 0 <= _1 <= 5 }",
        "out[_0, _1] = in_0[in_1[_0] % 4, _1]",
        [
            lp.GlobalArg("out", dtype=np.int32, shape=(526848, 6)),
            lp.GlobalArg("in_0", dtype=np.int32, shape=(4, 6)),
            lp.GlobalArg("in_1", dtype=np.int8, shape=(526848,)),
        ],
    )
    _pt_t_unit_0 = make_loopy_program(
        "{ [_0, _1] : 0 <= _0 <= 526847 and 0 <= _1 <= 5 }",
        "out[_0, _1] = in_0[in_1[_0, 0] % 131712, in_2[_0, _1] % 10]",
        [
            lp.GlobalArg("out", dtype=np.float64, shape=(526848, 6)),
            lp.GlobalArg("in_0", dtype=np.float64, shape=(131712, 10)),
            lp.GlobalArg("in_1", dtype=np.int32, shape=(526848, 1)),
            lp.GlobalArg("in_2", dtype=np.int32, shape=(526848, 6)),
        ],
    )
    ...
    _pt_t_unit_2 = make_loopy_program(
        "{ [_0, _1] : 0 <= _0 <= 526847 and 0 <= _1 <= 5 }",
        "out[_0, _1] = in_0[in_1[_0, 0] % 526848, in_2[_0, _1] % 6]",
        [
            lp.GlobalArg("out", dtype=np.float64, shape=(526848, 6)),
            lp.GlobalArg("in_0", dtype=np.float64, shape=(526848, 6)),
            lp.GlobalArg("in_1", dtype=np.int32, shape=(526848, 1)),
            lp.GlobalArg("in_2", dtype=np.int32, shape=(526848, 6)),
        ],
    )
    _pt_t_unit_3 = make_loopy_program(
        ...
        [
            lp.GlobalArg("out", dtype=np.float64, shape=(526848, 6)),
            lp.GlobalArg("_in0", dtype=np.float64, shape=(526848, 6)),
            lp.GlobalArg("_in1", dtype=np.float64, shape=(526848, 1)),
        ],
    )
    ...
    _pt_t_unit_5 = make_loopy_program(
        "{ [_0, _1] : 0 <= _0 <= 131711 and 0 <= _1 <= 9 }",
        "out[_0, _1] = _in0[_0, _1]*_in1[_0, 0]",
        [
            lp.GlobalArg("out", dtype=np.float64, shape=(131712, 10)),
            lp.GlobalArg("_in0", dtype=np.float64, shape=(131712, 10)),
            lp.GlobalArg("_in1", dtype=np.float64, shape=(131712, 1)),
        ],
    )
    _pt_t_unit_6 = make_loopy_program(
        ...
        [
            lp.GlobalArg("out", dtype=np.float64, shape=(131712, 10)),
            lp.GlobalArg("in_0", dtype=np.float64, shape=(131712, 1)),
        ],
    )
    ...
    _pt_tmp_31 = actx.np.reshape(_pt_data_4, (4, 131712, 1))
    ...
    _pt_tmp_44 = actx.np.reshape(_pt_data_5, (526848, 1))
    ...
    _pt_tmp_46 = actx.np.reshape(_pt_data_8, (526848, 1))
    ...
    _pt_tmp_48 = actx.np.reshape(_pt_data_12, (526848, 1))
    ...
    del _pt_tmp_35
    _pt_tmp_32 = actx.np.reshape(_pt_tmp_33, (4, 131712, 6))
    del _pt_tmp_34
    ...
    del _pt_tmp_61
    _pt_tmp_58 = actx.np.reshape(_pt_tmp_59, (4, 131712, 6))
    del _pt_tmp_60
    ...
    del _pt_tmp_89
    _pt_tmp_86 = actx.np.reshape(_pt_tmp_87, (4, 131712, 6))
    del _pt_tmp_88
    ...
    del _pt_tmp_108
    _pt_tmp_105 = actx.np.reshape(_pt_tmp_106, (4, 131712, 6))
    del _pt_tmp_107
    ...
    del _pt_tmp_122
    _pt_tmp_119 = actx.np.reshape(_pt_tmp_120, (4, 131712, 6))
    del _pt_tmp_121
    ...
    del _pt_tmp_141
    _pt_tmp_138 = actx.np.reshape(_pt_tmp_139, (4, 131712, 6))
    del _pt_tmp_140
    ...
    del _pt_tmp_158
    _pt_tmp_155 = actx.np.reshape(_pt_tmp_156, (4, 131712, 6))
    del _pt_tmp_157
    ...
    del _pt_tmp_172
    _pt_tmp_169 = actx.np.reshape(_pt_tmp_170, (4, 131712, 6))
    del _pt_tmp_171
    ...
    del _pt_tmp_191
    _pt_tmp_188 = actx.np.reshape(_pt_tmp_189, (4, 131712, 6))
    del _pt_tmp_190
    ...
    del _pt_tmp_205
    _pt_tmp_202 = actx.np.reshape(_pt_tmp_203, (4, 131712, 6))
    del _pt_tmp_204
    ...
    del _pt_tmp_231
    _pt_tmp_228 = actx.np.reshape(_pt_tmp_229, (4, 131712, 6))
    del _pt_tmp_230
    ...
    del _pt_tmp_290
    _pt_tmp_287 = actx.np.reshape(_pt_tmp_288, (4, 131712, 6))
    del _pt_tmp_289
    ...
    del _pt_tmp_304
    _pt_tmp_301 = actx.np.reshape(_pt_tmp_302, (4, 131712, 6))
    del _pt_tmp_303
    ...
    del _pt_tmp_317
    _pt_tmp_314 = actx.np.reshape(_pt_tmp_315, (4, 131712, 6))
    del _pt_tmp_316
    ...
    del _pt_tmp_347
    _pt_tmp_344 = actx.np.reshape(_pt_tmp_345, (4, 131712, 6))
    del _pt_tmp_346
    ...
    del _pt_tmp_621
    _pt_tmp_353 = actx.np.reshape(_pt_tmp_354, (4, 131712, 6))
    ...
    _pt_tmp_703 = _pt_tmp_700 + 1e-13
    _pt_tmp_702 = actx.einsum("ij -> i", _pt_tmp_703)
    del _pt_tmp_700
    _pt_tmp_698 = _pt_tmp_699 / _pt_tmp_702
    del _pt_tmp_703
    _pt_tmp_697 = actx.np.reshape(_pt_tmp_698, (131712, 1))
    del _pt_tmp_699, _pt_tmp_702
    _pt_tmp_696 = (
        actx.np.broadcast_to(_pt_tmp_697, (131712, 10))
        if actx.supports_nonscalar_broadcasting
    ...
    del _pt_tmp_722
    _pt_tmp_719 = actx.np.reshape(_pt_tmp_720, (4, 131712, 6))
    del _pt_tmp_721
    ...
    del _pt_tmp_736
    _pt_tmp_733 = actx.np.reshape(_pt_tmp_734, (4, 131712, 6))
    del _pt_tmp_735
    ...
    del _pt_tmp_748
    _pt_tmp_745 = actx.np.reshape(_pt_tmp_746, (4, 131712, 6))
    del _pt_tmp_747
    ...
    del _pt_tmp_756
    _pt_tmp_753 = actx.np.reshape(_pt_tmp_754, (4, 131712, 6))
    del _pt_tmp_755
    ...
    del _pt_tmp_840
    _pt_tmp_816 = actx.np.reshape(_pt_tmp_817, (4, 131712, 6))
    ...
    del _pt_tmp_872
    _pt_tmp_869 = actx.np.reshape(_pt_tmp_870, (4, 131712, 6))
    del _pt_tmp_871
    ...
    del _pt_tmp_939
    _pt_tmp_921 = actx.np.reshape(_pt_tmp_922, (4, 131712, 6))
    ...
    del _pt_tmp_991
    _pt_tmp_988 = actx.np.reshape(_pt_tmp_989, (4, 131712, 6))
    del _pt_tmp_990
    ...
    del _pt_tmp_1056
    _pt_tmp_1038 = actx.np.reshape(_pt_tmp_1039, (4, 131712, 6))
    ...
    del _pt_tmp_1104
    _pt_tmp_1101 = actx.np.reshape(_pt_tmp_1102, (4, 131712, 6))
    del _pt_tmp_1103
    ...
    del _pt_tmp_1169
    _pt_tmp_1151 = actx.np.reshape(_pt_tmp_1152, (4, 131712, 6))
    ...
    del _pt_tmp_1217
    _pt_tmp_1214 = actx.np.reshape(_pt_tmp_1215, (4, 131712, 6))
    del _pt_tmp_1216
...
class RHSInvoker:
    ...
    def _get_output_template(self):
        ...
        fpath = os.path.join(
            get_actx_dgfem_suite_path(),
            "suite/cns_without_chem_3D_P2/ref_outputs.pkl",
        )
