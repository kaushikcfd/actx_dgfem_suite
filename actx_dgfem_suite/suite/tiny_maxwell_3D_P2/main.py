...
def _rhs_inner(
    ...
    *,
    ...
    _pt_t_unit_11 = make_loopy_program(
        ...
        "out[_0, _1] = in_0[in_1[_0, 0] % 162, in_2[_0, _1] % 10]",
        [
            lp.GlobalArg("out", dtype=np.complex128, shape=(108, 6)),
            lp.GlobalArg("in_0", dtype=np.complex128, shape=(162, 10)),
            lp.GlobalArg("in_1", dtype=np.int32, shape=(108, 1)),
            lp.GlobalArg("in_2", dtype=np.int64, shape=(108, 6)),
        ],
    )
    _pt_t_unit_12 = make_loopy_program(
        "{ [_0, _1] : 0 <= _0 <= 107 and 0 <= _1 <= 5 }",
        "out[_0, _1] = cast(np:dtype('complex128'), _in0[_0, 0])*_in1[_0, _1]",
        [
            lp.GlobalArg("out", dtype=np.complex128, shape=(108, 6)),
            lp.GlobalArg("_in0", dtype=np.float64, shape=(108, 1)),
            lp.GlobalArg("_in1", dtype=np.complex128, shape=(108, 6)),
        ],
    )
    _pt_t_unit_13 = make_loopy_program(
        "{ [_0, _1] : 0 <= _0 <= 647 and 0 <= _1 <= 5 }",
        "out[_0, _1] = in_0[in_1[_0, 0] % 108, in_2[_0, _1] % 6]",
        [
            lp.GlobalArg("out", dtype=np.complex128, shape=(648, 6)),
            lp.GlobalArg("in_0", dtype=np.complex128, shape=(108, 6)),
            lp.GlobalArg("in_1", dtype=np.int32, shape=(648, 1)),
            lp.GlobalArg("in_2", dtype=np.int64, shape=(648, 6)),
        ],
    )
    _pt_t_unit_14 = make_loopy_program(
        "{ [_0, _1] : 0 <= _0 <= 539 and 0 <= _1 <= 5 }",
        "out[_0, _1] = _in0[_0, 0]*_in1[_0, _1]",
        [
            lp.GlobalArg("out", dtype=np.float64, shape=(540, 6)),
            lp.GlobalArg("_in0", dtype=np.float64, shape=(540, 1)),
            lp.GlobalArg("_in1", dtype=np.float64, shape=(540, 6)),
        ],
    )
    _pt_t_unit_15 = make_loopy_program(
        "{ [_0, _1] : 0 <= _0 <= 107 and 0 <= _1 <= 5 }",
        "out[_0, _1] = _in0[_0, 0]*_in1[_0, _1]",
        [
            lp.GlobalArg("out", dtype=np.float64, shape=(108, 6)),
    ...
    _pt_t_unit_3 = make_loopy_program(
        ...
        "out[_0, _1] = in_0[in_1[_0, 0] % 162, in_2[_0, _1] % 10]",
        [
            lp.GlobalArg("out", dtype=np.complex128, shape=(540, 6)),
            lp.GlobalArg("in_0", dtype=np.complex128, shape=(162, 10)),
            lp.GlobalArg("in_1", dtype=np.int32, shape=(540, 1)),
            lp.GlobalArg("in_2", dtype=np.int64, shape=(540, 6)),
        ],
    ...
    _pt_t_unit_4 = make_loopy_program(
        ...
        [
            lp.GlobalArg("out", dtype=np.complex128, shape=(540, 6)),
            lp.GlobalArg("in_0", dtype=np.complex128, shape=(540, 6)),
            lp.GlobalArg("in_1", dtype=np.int32, shape=(540, 1)),
            lp.GlobalArg("in_2", dtype=np.int64, shape=(540, 6)),
        ],
    )
    _pt_t_unit_5 = make_loopy_program(
        ...
        [
            lp.GlobalArg("out", dtype=np.complex128, shape=(540, 6)),
            lp.GlobalArg("_in0", dtype=np.float64, shape=(540, 1)),
            lp.GlobalArg("_in1", dtype=np.complex128, shape=(540, 6)),
        ],
    )
    ...
    _pt_t_unit_8 = make_loopy_program(
        ...
        [
            ...
            lp.GlobalArg("_in1", dtype=np.complex128, shape=(648, 6)),
        ],
    )
    ...
    _pt_tmp_10 = (-1 + 0j) * _pt_tmp_11
    _pt_tmp_4 = _pt_tmp_5 + _pt_tmp_10
    del _pt_tmp_11
    _pt_tmp_3 = 0j - _pt_tmp_4
    ...
    _pt_tmp_19 = actx.np.reshape(_pt_data_4, (4, 162, 1))
    ...
    del _pt_tmp_38
    _pt_tmp_41 = actx.np.reshape(_pt_data_10, (540, 1))
    ...
    _pt_tmp_52 = (
        ...
        if actx.permits_advanced_indexing
            ...
            _pt_t_unit_3, in_0=_actx_in_1_1_0, in_1=_pt_tmp_39, in_2=_pt_tmp_40
        )["out"]
    )
    ...
    _pt_tmp_51 = 0j + _pt_tmp_52
    _pt_tmp_50 = (
        _pt_tmp_51[_pt_tmp_41, _pt_tmp_42]
        if actx.permits_advanced_indexing
        else actx.call_loopy(
            _pt_t_unit_4, in_0=_pt_tmp_51, in_1=_pt_tmp_41, in_2=_pt_tmp_42
        )["out"]
    )
    del _pt_tmp_52
    ...
    _pt_tmp_49 = 0j + _pt_tmp_50
    _pt_tmp_48 = _pt_tmp_49 - _pt_tmp_51
    del _pt_tmp_50
    _pt_tmp_46 = (
        _pt_tmp_47 * _pt_tmp_48
        if actx.supports_nonscalar_broadcasting
        else actx.call_loopy(_pt_t_unit_5, _in0=_pt_tmp_47, _in1=_pt_tmp_48)["out"]
    )
    del _pt_tmp_49, _pt_tmp_51
    _pt_tmp_45 = 0j + _pt_tmp_46
    ...
    _pt_tmp_59 = (
        ...
        if actx.permits_advanced_indexing
            ...
            _pt_t_unit_3, in_0=_actx_in_1_0_0, in_1=_pt_tmp_39, in_2=_pt_tmp_40
        )["out"]
    )
    ...
    _pt_tmp_58 = 0j + _pt_tmp_59
    _pt_tmp_57 = (
        _pt_tmp_58[_pt_tmp_41, _pt_tmp_42]
        if actx.permits_advanced_indexing
        else actx.call_loopy(
            _pt_t_unit_4, in_0=_pt_tmp_58, in_1=_pt_tmp_41, in_2=_pt_tmp_42
        )["out"]
    )
    del _pt_tmp_59
    ...
    _pt_tmp_56 = 0j + _pt_tmp_57
    _pt_tmp_55 = _pt_tmp_56 - _pt_tmp_58
    del _pt_tmp_57
    _pt_tmp_53 = (
        _pt_tmp_54 * _pt_tmp_55
        if actx.supports_nonscalar_broadcasting
        else actx.call_loopy(_pt_t_unit_5, _in0=_pt_tmp_54, _in1=_pt_tmp_55)["out"]
    )
    del _pt_tmp_56, _pt_tmp_58
    _pt_tmp_44 = _pt_tmp_45 + _pt_tmp_53
    _pt_tmp_43 = (0.5 + 0j) * _pt_tmp_44
    ...
    _pt_tmp_30 = (
        ...
        if actx.supports_nonscalar_broadcasting
        else actx.call_loopy(_pt_t_unit_5, _in0=_pt_tmp_31, _in1=_pt_tmp_32)["out"]
    )
    del _pt_tmp_33, _pt_tmp_43
    _pt_tmp_29 = 0j + _pt_tmp_30
    ...
    _pt_tmp_68 = (
        ...
        if actx.permits_advanced_indexing
            ...
            _pt_t_unit_3, in_0=_actx_in_1_4_0, in_1=_pt_tmp_39, in_2=_pt_tmp_40
        )["out"]
    )
    ...
    _pt_tmp_67 = 0j + _pt_tmp_68
    _pt_tmp_66 = (
        _pt_tmp_67[_pt_tmp_41, _pt_tmp_42]
        if actx.permits_advanced_indexing
        else actx.call_loopy(
            _pt_t_unit_4, in_0=_pt_tmp_67, in_1=_pt_tmp_41, in_2=_pt_tmp_42
        )["out"]
    )
    del _pt_tmp_68
    ...
    _pt_tmp_65 = 0j + _pt_tmp_66
    _pt_tmp_64 = _pt_tmp_65 - _pt_tmp_67
    del _pt_tmp_66
    _pt_tmp_63 = (1 + 0j) * _pt_tmp_64
    ...
    _pt_tmp_78 = (
        ...
        if actx.permits_advanced_indexing
            ...
            _pt_t_unit_3, in_0=_actx_in_1_2_0, in_1=_pt_tmp_39, in_2=_pt_tmp_40
        )["out"]
    )
    ...
    _pt_tmp_77 = 0j + _pt_tmp_78
    _pt_tmp_76 = (
        _pt_tmp_77[_pt_tmp_41, _pt_tmp_42]
        if actx.permits_advanced_indexing
        else actx.call_loopy(
            _pt_t_unit_4, in_0=_pt_tmp_77, in_1=_pt_tmp_41, in_2=_pt_tmp_42
        )["out"]
    )
    del _pt_tmp_78
    ...
    _pt_tmp_75 = 0j + _pt_tmp_76
    _pt_tmp_74 = _pt_tmp_75 - _pt_tmp_77
    del _pt_tmp_76
    _pt_tmp_72 = (
        _pt_tmp_73 * _pt_tmp_74
        if actx.supports_nonscalar_broadcasting
        else actx.call_loopy(_pt_t_unit_5, _in0=_pt_tmp_73, _in1=_pt_tmp_74)["out"]
    )
    del _pt_tmp_75, _pt_tmp_77
    _pt_tmp_71 = 0j + _pt_tmp_72
    _pt_tmp_80 = 1.0 * _pt_data_14
    del _pt_tmp_72
    _pt_tmp_79 = (
        _pt_tmp_80 * _pt_tmp_55
        if actx.supports_nonscalar_broadcasting
        else actx.call_loopy(_pt_t_unit_5, _in0=_pt_tmp_80, _in1=_pt_tmp_55)["out"]
    )
    _pt_tmp_70 = _pt_tmp_71 + _pt_tmp_79
    _pt_tmp_69 = (0.5 + 0j) * _pt_tmp_70
    ...
    _pt_tmp_60 = (
        ...
        if actx.supports_nonscalar_broadcasting
        else actx.call_loopy(_pt_t_unit_5, _in0=_pt_tmp_61, _in1=_pt_tmp_62)["out"]
    )
    del _pt_tmp_63, _pt_tmp_69
    _pt_tmp_28 = _pt_tmp_29 + _pt_tmp_60
    _pt_tmp_27 = (-0.5 + 0j) * _pt_tmp_28
    del _pt_tmp_29, _pt_tmp_60
    _pt_data_15 = actx.thaw(npzfile["_pt_data_15"])
    del _pt_tmp_28
    _pt_tmp_81 = actx.np.reshape(_pt_data_15, (648, 1))
    _pt_data_16 = actx.thaw(npzfile["_pt_data_16"])
    _pt_data_17 = actx.thaw(npzfile["_pt_data_17"])
    _pt_tmp_82 = (
        _pt_data_16[_pt_data_17]
        if actx.permits_advanced_indexing
        else actx.call_loopy(_pt_t_unit_6, in_0=_pt_data_16, in_1=_pt_data_17)["out"]
    )
    _pt_tmp_26 = (
        _pt_tmp_27[_pt_tmp_81, _pt_tmp_82]
        if actx.permits_advanced_indexing
        else actx.call_loopy(
            _pt_t_unit_7, in_0=_pt_tmp_27, in_1=_pt_tmp_81, in_2=_pt_tmp_82
        )["out"]
    )
    _pt_tmp_24 = (
        actx.np.where(_pt_tmp_25, _pt_tmp_26, 0)
        if actx.supports_nonscalar_broadcasting
        else actx.call_loopy(_pt_t_unit_8, _in0=_pt_tmp_25, _in1=_pt_tmp_26)["out"]
    )
    del _pt_tmp_27
    ...
    _pt_tmp_23 = 0j + _pt_tmp_24
    _pt_tmp_22 = 0j + _pt_tmp_23
    del _pt_tmp_24
    _pt_data_18 = actx.thaw(npzfile["_pt_data_18"])
    del _pt_tmp_23
    _pt_tmp_89 = actx.np.reshape(_pt_data_18, (648, 1))
    _pt_data_19 = actx.thaw(npzfile["_pt_data_19"])
    _pt_tmp_95 = 1.0 * _pt_data_19
    _pt_data_20 = actx.thaw(npzfile["_pt_data_20"])
    _pt_tmp_101 = actx.np.reshape(_pt_data_20, (108, 1))
    _pt_data_21 = actx.thaw(npzfile["_pt_data_21"])
    _pt_tmp_102 = (
        _pt_data_8[_pt_data_21]
        if actx.permits_advanced_indexing
        else actx.call_loopy(_pt_t_unit_9, in_0=_pt_data_8, in_1=_pt_data_21)["out"]
    )
    _pt_tmp_100 = (
        _actx_in_1_5_0[_pt_tmp_101, _pt_tmp_102]
        if actx.permits_advanced_indexing
        else actx.call_loopy(
            _pt_t_unit_10, in_0=_actx_in_1_5_0, in_1=_pt_tmp_101, in_2=_pt_tmp_102
        )["out"]
    )
    ...
    _pt_tmp_111 = (
        ...
        if actx.permits_advanced_indexing
            ...
            _pt_t_unit_11, in_0=_actx_in_1_1_0, in_1=_pt_tmp_101, in_2=_pt_tmp_102
        )["out"]
    )
    ...
    _pt_tmp_106 = (
        ...
        if actx.supports_nonscalar_broadcasting
        else actx.call_loopy(_pt_t_unit_12, _in0=_pt_tmp_107, _in1=_pt_tmp_108)[
            "out"
        ]
    )
    del _pt_tmp_109, _pt_tmp_110
    _pt_tmp_105 = 0j + _pt_tmp_106
    ...
    _pt_tmp_117 = (
        ...
        if actx.permits_advanced_indexing
            ...
            _pt_t_unit_11, in_0=_actx_in_1_0_0, in_1=_pt_tmp_101, in_2=_pt_tmp_102
        )["out"]
    )
    ...
    _pt_tmp_112 = (
        ...
        if actx.supports_nonscalar_broadcasting
        else actx.call_loopy(_pt_t_unit_12, _in0=_pt_tmp_113, _in1=_pt_tmp_114)[
            "out"
        ]
    )
    del _pt_tmp_115, _pt_tmp_116
    _pt_tmp_104 = _pt_tmp_105 + _pt_tmp_112
    _pt_tmp_103 = (0.5 + 0j) * _pt_tmp_104
    ...
    _pt_tmp_94 = (
        ...
        if actx.supports_nonscalar_broadcasting
        else actx.call_loopy(_pt_t_unit_12, _in0=_pt_tmp_95, _in1=_pt_tmp_96)["out"]
    )
    del _pt_tmp_103, _pt_tmp_97
    _pt_tmp_93 = 0j + _pt_tmp_94
    ...
    _pt_tmp_124 = (
        ...
        if actx.permits_advanced_indexing
            ...
            _pt_t_unit_11, in_0=_actx_in_1_4_0, in_1=_pt_tmp_101, in_2=_pt_tmp_102
        )["out"]
    )
    ...
    _pt_tmp_123 = 0j + _pt_tmp_124
    _pt_tmp_122 = _pt_tmp_123 - _pt_tmp_123
    del _pt_tmp_124
    _pt_tmp_121 = (1 + 0j) * _pt_tmp_122
    del _pt_tmp_123
    ...
    _pt_tmp_133 = (
        ...
        if actx.permits_advanced_indexing
            ...
            _pt_t_unit_11, in_0=_actx_in_1_2_0, in_1=_pt_tmp_101, in_2=_pt_tmp_102
        )["out"]
    )
    ...
    _pt_tmp_128 = (
        ...
        if actx.supports_nonscalar_broadcasting
        else actx.call_loopy(_pt_t_unit_12, _in0=_pt_tmp_129, _in1=_pt_tmp_130)[
            "out"
        ]
    )
    del _pt_tmp_131, _pt_tmp_132
    _pt_tmp_127 = 0j + _pt_tmp_128
    _pt_tmp_135 = 1.0 * _pt_data_23
    del _pt_tmp_128
    _pt_tmp_134 = (
        _pt_tmp_135 * _pt_tmp_114
        if actx.supports_nonscalar_broadcasting
        else actx.call_loopy(_pt_t_unit_12, _in0=_pt_tmp_135, _in1=_pt_tmp_114)[
            "out"
        ]
    )
    _pt_tmp_126 = _pt_tmp_127 + _pt_tmp_134
    _pt_tmp_125 = (0.5 + 0j) * _pt_tmp_126
    ...
    _pt_tmp_118 = (
        ...
        if actx.supports_nonscalar_broadcasting
        else actx.call_loopy(_pt_t_unit_12, _in0=_pt_tmp_119, _in1=_pt_tmp_120)[
            "out"
        ]
    )
    del _pt_tmp_121, _pt_tmp_125
    _pt_tmp_92 = _pt_tmp_93 + _pt_tmp_118
    _pt_tmp_91 = (-0.5 + 0j) * _pt_tmp_92
    del _pt_tmp_118, _pt_tmp_93
    _pt_data_24 = actx.thaw(npzfile["_pt_data_24"])
    del _pt_tmp_92
    _pt_tmp_136 = actx.np.reshape(_pt_data_24, (648, 1))
    _pt_tmp_90 = (
        _pt_tmp_91[_pt_tmp_136, _pt_tmp_82]
        if actx.permits_advanced_indexing
        else actx.call_loopy(
            _pt_t_unit_13, in_0=_pt_tmp_91, in_1=_pt_tmp_136, in_2=_pt_tmp_82
        )["out"]
    )
    _pt_tmp_88 = (
        actx.np.where(_pt_tmp_89, _pt_tmp_90, 0)
        if actx.supports_nonscalar_broadcasting
        else actx.call_loopy(_pt_t_unit_8, _in0=_pt_tmp_89, _in1=_pt_tmp_90)["out"]
    )
    del _pt_tmp_91
    ...
    _pt_tmp_87 = 0j + _pt_tmp_88
    _pt_tmp_86 = 0j + _pt_tmp_87
    del _pt_tmp_88
    _pt_tmp_137 = actx.np.zeros((648, 6), dtype=np.complex128)
    del _pt_tmp_87
    ...
    del _pt_tmp_84
    _pt_tmp_20 = actx.np.reshape(_pt_tmp_21, (4, 162, 6))
    ...
    _pt_tmp_0 = _pt_tmp_1 / np.complex128(1 + 0j)
    ...
    _pt_tmp_148 = (1 + 0j) * _pt_tmp_149
    _pt_tmp_142 = _pt_tmp_143 + _pt_tmp_148
    del _pt_tmp_149
    _pt_tmp_141 = 0j - _pt_tmp_142
    ...
    _pt_tmp_161 = (
        ...
        if actx.supports_nonscalar_broadcasting
        else actx.call_loopy(_pt_t_unit_5, _in0=_pt_tmp_73, _in1=_pt_tmp_32)["out"]
    )
    del _pt_tmp_141
    _pt_tmp_160 = 0j + _pt_tmp_161
    del _pt_tmp_32
    _pt_tmp_169 = (
        _actx_in_1_3_0[_pt_tmp_39, _pt_tmp_40]
        if actx.permits_advanced_indexing
        else actx.call_loopy(
            _pt_t_unit_3, in_0=_actx_in_1_3_0, in_1=_pt_tmp_39, in_2=_pt_tmp_40
        )["out"]
    )
    del _pt_tmp_161
    ...
    _pt_tmp_168 = 0j + _pt_tmp_169
    _pt_tmp_167 = (
        _pt_tmp_168[_pt_tmp_41, _pt_tmp_42]
        if actx.permits_advanced_indexing
        else actx.call_loopy(
            _pt_t_unit_4, in_0=_pt_tmp_168, in_1=_pt_tmp_41, in_2=_pt_tmp_42
        )["out"]
    )
    del _pt_tmp_169
    ...
    _pt_tmp_166 = 0j + _pt_tmp_167
    _pt_tmp_165 = _pt_tmp_166 - _pt_tmp_168
    del _pt_tmp_167
    _pt_tmp_164 = (1 + 0j) * _pt_tmp_165
    del _pt_tmp_166, _pt_tmp_168
    _pt_tmp_173 = (
        _pt_tmp_31 * _pt_tmp_74
        if actx.supports_nonscalar_broadcasting
        else actx.call_loopy(_pt_t_unit_5, _in0=_pt_tmp_31, _in1=_pt_tmp_74)["out"]
    )
    _pt_tmp_172 = 0j + _pt_tmp_173
    _pt_tmp_174 = (
        _pt_tmp_61 * _pt_tmp_48
        if actx.supports_nonscalar_broadcasting
        else actx.call_loopy(_pt_t_unit_5, _in0=_pt_tmp_61, _in1=_pt_tmp_48)["out"]
    )
    del _pt_tmp_173
    _pt_tmp_171 = _pt_tmp_172 + _pt_tmp_174
    _pt_tmp_170 = (0.5 + 0j) * _pt_tmp_171
    ...
    _pt_tmp_162 = (
        ...
        if actx.supports_nonscalar_broadcasting
        else actx.call_loopy(_pt_t_unit_5, _in0=_pt_tmp_80, _in1=_pt_tmp_163)["out"]
    )
    del _pt_tmp_164, _pt_tmp_170
    _pt_tmp_159 = _pt_tmp_160 + _pt_tmp_162
    _pt_tmp_158 = (-0.5 + 0j) * _pt_tmp_159
    del _pt_tmp_160, _pt_tmp_162
    _pt_tmp_157 = (
        _pt_tmp_158[_pt_tmp_81, _pt_tmp_82]
        if actx.permits_advanced_indexing
        else actx.call_loopy(
            _pt_t_unit_7, in_0=_pt_tmp_158, in_1=_pt_tmp_81, in_2=_pt_tmp_82
        )["out"]
    )
    del _pt_tmp_159
    _pt_tmp_156 = (
        ...
        if actx.supports_nonscalar_broadcasting
        else actx.call_loopy(_pt_t_unit_8, _in0=_pt_tmp_25, _in1=_pt_tmp_157)["out"]
    )
    del _pt_tmp_158
    ...
    _pt_tmp_155 = 0j + _pt_tmp_156
    _pt_tmp_154 = 0j + _pt_tmp_155
    del _pt_tmp_156
    _pt_tmp_185 = (
        _pt_tmp_129 * _pt_tmp_96
        if actx.supports_nonscalar_broadcasting
        else actx.call_loopy(_pt_t_unit_12, _in0=_pt_tmp_129, _in1=_pt_tmp_96)["out"]
    )
    del _pt_tmp_155
    _pt_tmp_184 = 0j + _pt_tmp_185
    del _pt_tmp_96
    _pt_tmp_191 = (
        _actx_in_1_3_0[_pt_tmp_101, _pt_tmp_102]
        if actx.permits_advanced_indexing
        else actx.call_loopy(
            _pt_t_unit_11, in_0=_actx_in_1_3_0, in_1=_pt_tmp_101, in_2=_pt_tmp_102
        )["out"]
    )
    del _pt_tmp_185
    ...
    _pt_tmp_190 = 0j + _pt_tmp_191
    _pt_tmp_189 = _pt_tmp_190 - _pt_tmp_190
    del _pt_tmp_191
    _pt_tmp_188 = (1 + 0j) * _pt_tmp_189
    del _pt_tmp_190
    _pt_tmp_195 = (
        _pt_tmp_95 * _pt_tmp_130
        if actx.supports_nonscalar_broadcasting
        else actx.call_loopy(_pt_t_unit_12, _in0=_pt_tmp_95, _in1=_pt_tmp_130)["out"]
    )
    _pt_tmp_194 = 0j + _pt_tmp_195
    _pt_tmp_196 = (
        _pt_tmp_119 * _pt_tmp_108
        if actx.supports_nonscalar_broadcasting
        else actx.call_loopy(_pt_t_unit_12, _in0=_pt_tmp_119, _in1=_pt_tmp_108)[
            "out"
        ]
    )
    del _pt_tmp_195
    _pt_tmp_193 = _pt_tmp_194 + _pt_tmp_196
    _pt_tmp_192 = (0.5 + 0j) * _pt_tmp_193
    ...
    _pt_tmp_182 = (-0.5 + 0j) * _pt_tmp_183
    del _pt_tmp_184, _pt_tmp_186
    _pt_tmp_181 = (
        _pt_tmp_182[_pt_tmp_136, _pt_tmp_82]
        if actx.permits_advanced_indexing
        else actx.call_loopy(
            _pt_t_unit_13, in_0=_pt_tmp_182, in_1=_pt_tmp_136, in_2=_pt_tmp_82
        )["out"]
    )
    del _pt_tmp_183
    _pt_tmp_180 = (
        ...
        if actx.supports_nonscalar_broadcasting
        else actx.call_loopy(_pt_t_unit_8, _in0=_pt_tmp_89, _in1=_pt_tmp_181)["out"]
    )
    del _pt_tmp_182
    ...
    _pt_tmp_179 = 0j + _pt_tmp_180
    _pt_tmp_178 = 0j + _pt_tmp_179
    del _pt_tmp_180
    ...
    del _pt_tmp_176
    _pt_tmp_152 = actx.np.reshape(_pt_tmp_153, (4, 162, 6))
    ...
    _pt_tmp_138 = _pt_tmp_139 / np.complex128(1 + 0j)
    ...
    _pt_tmp_203 = (1 + 0j) * _pt_tmp_204
    _pt_tmp_202 = 0j + _pt_tmp_203
    del _pt_tmp_204
    ...
    _pt_tmp_205 = (-1 + 0j) * _pt_tmp_206
    _pt_tmp_201 = _pt_tmp_202 + _pt_tmp_205
    del _pt_tmp_206
    _pt_tmp_200 = 0j - _pt_tmp_201
    ...
    _pt_tmp_218 = (
        ...
        if actx.supports_nonscalar_broadcasting
        else actx.call_loopy(_pt_t_unit_5, _in0=_pt_tmp_47, _in1=_pt_tmp_62)["out"]
    )
    del _pt_tmp_200
    _pt_tmp_217 = 0j + _pt_tmp_218
    del _pt_tmp_62
    _pt_tmp_219 = (
        _pt_tmp_54 * _pt_tmp_163
        if actx.supports_nonscalar_broadcasting
        else actx.call_loopy(_pt_t_unit_5, _in0=_pt_tmp_54, _in1=_pt_tmp_163)["out"]
    )
    del _pt_tmp_218
    _pt_tmp_216 = _pt_tmp_217 + _pt_tmp_219
    del _pt_tmp_163
    _pt_tmp_215 = (-0.5 + 0j) * _pt_tmp_216
    del _pt_tmp_217, _pt_tmp_219
    _pt_tmp_214 = (
        _pt_tmp_215[_pt_tmp_81, _pt_tmp_82]
        if actx.permits_advanced_indexing
        else actx.call_loopy(
            _pt_t_unit_7, in_0=_pt_tmp_215, in_1=_pt_tmp_81, in_2=_pt_tmp_82
        )["out"]
    )
    del _pt_tmp_216
    _pt_tmp_213 = (
        ...
        if actx.supports_nonscalar_broadcasting
        else actx.call_loopy(_pt_t_unit_8, _in0=_pt_tmp_25, _in1=_pt_tmp_214)["out"]
    )
    del _pt_tmp_215
    ...
    _pt_tmp_212 = 0j + _pt_tmp_213
    _pt_tmp_211 = 0j + _pt_tmp_212
    del _pt_tmp_213
    _pt_tmp_230 = (
        _pt_tmp_107 * _pt_tmp_120
        if actx.supports_nonscalar_broadcasting
        else actx.call_loopy(_pt_t_unit_12, _in0=_pt_tmp_107, _in1=_pt_tmp_120)[
            "out"
        ]
    )
    del _pt_tmp_212
    _pt_tmp_229 = 0j + _pt_tmp_230
    del _pt_tmp_120
    _pt_tmp_231 = (
    ...
    del _pt_tmp_187
    _pt_tmp_227 = (-0.5 + 0j) * _pt_tmp_228
    del _pt_tmp_229, _pt_tmp_231
    _pt_tmp_226 = (
        _pt_tmp_227[_pt_tmp_136, _pt_tmp_82]
        if actx.permits_advanced_indexing
        else actx.call_loopy(
            _pt_t_unit_13, in_0=_pt_tmp_227, in_1=_pt_tmp_136, in_2=_pt_tmp_82
        )["out"]
    )
    del _pt_tmp_228
    _pt_tmp_225 = (
        ...
        if actx.supports_nonscalar_broadcasting
        else actx.call_loopy(_pt_t_unit_8, _in0=_pt_tmp_89, _in1=_pt_tmp_226)["out"]
    )
    del _pt_tmp_227
    ...
    _pt_tmp_224 = 0j + _pt_tmp_225
    _pt_tmp_223 = 0j + _pt_tmp_224
    del _pt_tmp_225
    ...
    del _pt_tmp_221
    _pt_tmp_209 = actx.np.reshape(_pt_tmp_210, (4, 162, 6))
    ...
    _pt_tmp_197 = _pt_tmp_198 / np.complex128(1 + 0j)
    ...
    _pt_tmp_237 = (1 + 0j) * _pt_tmp_238
    _pt_tmp_236 = 0j + _pt_tmp_237
    del _pt_tmp_238
    ...
    _pt_tmp_239 = (-1 + 0j) * _pt_tmp_240
    _pt_tmp_235 = _pt_tmp_236 + _pt_tmp_239
    del _pt_tmp_240
    _pt_tmp_234 = -1 * _pt_tmp_235
    del _pt_tmp_236, _pt_tmp_239
    _pt_tmp_254 = (1 + 0j) * _pt_tmp_74
    del _pt_tmp_235
    _pt_tmp_258 = (
        _pt_tmp_47 * _pt_tmp_64
        if actx.supports_nonscalar_broadcasting
        else actx.call_loopy(_pt_t_unit_5, _in0=_pt_tmp_47, _in1=_pt_tmp_64)["out"]
    )
    del _pt_tmp_74
    _pt_tmp_257 = 0j + _pt_tmp_258
    _pt_tmp_259 = (
        _pt_tmp_54 * _pt_tmp_165
        if actx.supports_nonscalar_broadcasting
        else actx.call_loopy(_pt_t_unit_5, _in0=_pt_tmp_54, _in1=_pt_tmp_165)["out"]
    )
    del _pt_tmp_258
    _pt_tmp_256 = _pt_tmp_257 + _pt_tmp_259
    _pt_tmp_255 = (0.5 + 0j) * _pt_tmp_256
    ...
    _pt_tmp_252 = (
        ...
        if actx.supports_nonscalar_broadcasting
        else actx.call_loopy(_pt_t_unit_5, _in0=_pt_tmp_31, _in1=_pt_tmp_253)["out"]
    )
    del _pt_tmp_254, _pt_tmp_255
    _pt_tmp_251 = 0j + _pt_tmp_252
    _pt_tmp_262 = (1 + 0j) * _pt_tmp_48
    del _pt_tmp_252
    _pt_tmp_266 = (
        _pt_tmp_73 * _pt_tmp_34
        if actx.supports_nonscalar_broadcasting
        else actx.call_loopy(_pt_t_unit_14, _in0=_pt_tmp_73, _in1=_pt_tmp_34)["out"]
    )
    del _pt_tmp_48
    ...
    _pt_tmp_267 = (
        ...
        if actx.supports_nonscalar_broadcasting
        else actx.call_loopy(_pt_t_unit_5, _in0=_pt_tmp_80, _in1=_pt_tmp_165)["out"]
    )
    del _pt_tmp_266
    _pt_tmp_264 = _pt_tmp_265 + _pt_tmp_267
    del _pt_tmp_165
    _pt_tmp_263 = (0.5 + 0j) * _pt_tmp_264
    ...
    _pt_tmp_260 = (
        ...
        if actx.supports_nonscalar_broadcasting
        else actx.call_loopy(_pt_t_unit_5, _in0=_pt_tmp_61, _in1=_pt_tmp_261)["out"]
    )
    del _pt_tmp_262, _pt_tmp_263
    _pt_tmp_250 = _pt_tmp_251 + _pt_tmp_260
    _pt_tmp_249 = (0.5 + 0j) * _pt_tmp_250
    del _pt_tmp_251, _pt_tmp_260
    _pt_tmp_248 = (
        _pt_tmp_249[_pt_tmp_81, _pt_tmp_82]
        if actx.permits_advanced_indexing
        else actx.call_loopy(
            _pt_t_unit_7, in_0=_pt_tmp_249, in_1=_pt_tmp_81, in_2=_pt_tmp_82
        )["out"]
    )
    del _pt_tmp_250
    _pt_tmp_247 = (
        ...
        if actx.supports_nonscalar_broadcasting
        else actx.call_loopy(_pt_t_unit_8, _in0=_pt_tmp_25, _in1=_pt_tmp_248)["out"]
    )
    del _pt_tmp_249
    ...
    _pt_tmp_246 = 0j + _pt_tmp_247
    _pt_tmp_245 = 0j + _pt_tmp_246
    del _pt_tmp_247
    _pt_tmp_280 = (1 + 0j) * _pt_tmp_130
    del _pt_tmp_246
    _pt_tmp_284 = (
        _pt_tmp_107 * _pt_tmp_122
        if actx.supports_nonscalar_broadcasting
        else actx.call_loopy(_pt_t_unit_12, _in0=_pt_tmp_107, _in1=_pt_tmp_122)[
            "out"
        ]
    )
    del _pt_tmp_130
    _pt_tmp_283 = 0j + _pt_tmp_284
    _pt_tmp_285 = (
        _pt_tmp_113 * _pt_tmp_189
        if actx.supports_nonscalar_broadcasting
        else actx.call_loopy(_pt_t_unit_12, _in0=_pt_tmp_113, _in1=_pt_tmp_189)[
            "out"
        ]
    )
    del _pt_tmp_284
    _pt_tmp_282 = _pt_tmp_283 + _pt_tmp_285
    _pt_tmp_281 = (0.5 + 0j) * _pt_tmp_282
    ...
    _pt_tmp_278 = (
        ...
        if actx.supports_nonscalar_broadcasting
        else actx.call_loopy(_pt_t_unit_12, _in0=_pt_tmp_95, _in1=_pt_tmp_279)["out"]
    )
    del _pt_tmp_280, _pt_tmp_281
    _pt_tmp_277 = 0j + _pt_tmp_278
    _pt_tmp_288 = (1 + 0j) * _pt_tmp_108
    del _pt_tmp_278
    _pt_tmp_292 = (
        _pt_tmp_129 * _pt_tmp_98
        if actx.supports_nonscalar_broadcasting
        else actx.call_loopy(_pt_t_unit_15, _in0=_pt_tmp_129, _in1=_pt_tmp_98)["out"]
    )
    del _pt_tmp_108
    ...
    _pt_tmp_293 = (
        ...
        if actx.supports_nonscalar_broadcasting
        else actx.call_loopy(_pt_t_unit_12, _in0=_pt_tmp_135, _in1=_pt_tmp_189)[
            "out"
        ]
    )
    del _pt_tmp_292
    ...
    del _pt_tmp_189
    _pt_tmp_289 = (0.5 + 0j) * _pt_tmp_290
    ...
    _pt_tmp_275 = (0.5 + 0j) * _pt_tmp_276
    del _pt_tmp_277, _pt_tmp_286
    _pt_tmp_274 = (
        _pt_tmp_275[_pt_tmp_136, _pt_tmp_82]
        if actx.permits_advanced_indexing
        else actx.call_loopy(
            _pt_t_unit_13, in_0=_pt_tmp_275, in_1=_pt_tmp_136, in_2=_pt_tmp_82
        )["out"]
    )
    del _pt_tmp_276
    _pt_tmp_273 = (
        ...
        if actx.supports_nonscalar_broadcasting
        else actx.call_loopy(_pt_t_unit_8, _in0=_pt_tmp_89, _in1=_pt_tmp_274)["out"]
    )
    del _pt_tmp_275
    ...
    _pt_tmp_272 = 0j + _pt_tmp_273
    _pt_tmp_271 = 0j + _pt_tmp_272
    del _pt_tmp_273
    ...
    del _pt_tmp_269
    _pt_tmp_243 = actx.np.reshape(_pt_tmp_244, (4, 162, 6))
    ...
    _pt_tmp_232 = _pt_tmp_233 / np.complex128(1 + 0j)
    ...
    _pt_tmp_299 = (-1 + 0j) * _pt_tmp_300
    _pt_tmp_298 = 0j + _pt_tmp_299
    del _pt_tmp_300
    ...
    _pt_tmp_314 = (
        ...
        if actx.supports_nonscalar_broadcasting
        else actx.call_loopy(_pt_t_unit_5, _in0=_pt_tmp_73, _in1=_pt_tmp_253)["out"]
    )
    del _pt_tmp_297
    _pt_tmp_313 = 0j + _pt_tmp_314
    del _pt_tmp_253, _pt_tmp_73
    _pt_tmp_317 = (1 + 0j) * _pt_tmp_55
    del _pt_tmp_314
    _pt_tmp_321 = (
        _pt_tmp_31 * _pt_tmp_34
        if actx.supports_nonscalar_broadcasting
        else actx.call_loopy(_pt_t_unit_14, _in0=_pt_tmp_31, _in1=_pt_tmp_34)["out"]
    )
    del _pt_tmp_55
    ...
    _pt_tmp_322 = (
        ...
        if actx.supports_nonscalar_broadcasting
        else actx.call_loopy(_pt_t_unit_5, _in0=_pt_tmp_61, _in1=_pt_tmp_64)["out"]
    )
    del _pt_tmp_321
    _pt_tmp_319 = _pt_tmp_320 + _pt_tmp_322
    del _pt_tmp_61, _pt_tmp_64
    _pt_tmp_318 = (0.5 + 0j) * _pt_tmp_319
    ...
    _pt_tmp_315 = (
        ...
        if actx.supports_nonscalar_broadcasting
        else actx.call_loopy(_pt_t_unit_5, _in0=_pt_tmp_80, _in1=_pt_tmp_316)["out"]
    )
    del _pt_tmp_317, _pt_tmp_318
    _pt_tmp_312 = _pt_tmp_313 + _pt_tmp_315
    del _pt_tmp_80
    _pt_tmp_311 = (0.5 + 0j) * _pt_tmp_312
    del _pt_tmp_313, _pt_tmp_315
    _pt_tmp_310 = (
        _pt_tmp_311[_pt_tmp_81, _pt_tmp_82]
        if actx.permits_advanced_indexing
        else actx.call_loopy(
            _pt_t_unit_7, in_0=_pt_tmp_311, in_1=_pt_tmp_81, in_2=_pt_tmp_82
        )["out"]
    )
    del _pt_tmp_312
    _pt_tmp_309 = (
        ...
        if actx.supports_nonscalar_broadcasting
        else actx.call_loopy(_pt_t_unit_8, _in0=_pt_tmp_25, _in1=_pt_tmp_310)["out"]
    )
    del _pt_tmp_311
    ...
    _pt_tmp_308 = 0j + _pt_tmp_309
    _pt_tmp_307 = 0j + _pt_tmp_308
    del _pt_tmp_309
    _pt_tmp_333 = (
        _pt_tmp_129 * _pt_tmp_279
        if actx.supports_nonscalar_broadcasting
        else actx.call_loopy(_pt_t_unit_12, _in0=_pt_tmp_129, _in1=_pt_tmp_279)[
            "out"
        ]
    )
    del _pt_tmp_308
    _pt_tmp_332 = 0j + _pt_tmp_333
    del _pt_tmp_129, _pt_tmp_279
    _pt_tmp_336 = (1 + 0j) * _pt_tmp_114
    del _pt_tmp_333
    _pt_tmp_340 = (
        _pt_tmp_95 * _pt_tmp_98
        if actx.supports_nonscalar_broadcasting
        else actx.call_loopy(_pt_t_unit_15, _in0=_pt_tmp_95, _in1=_pt_tmp_98)["out"]
    )
    del _pt_tmp_114
    ...
    _pt_tmp_341 = (
        ...
        if actx.supports_nonscalar_broadcasting
        else actx.call_loopy(_pt_t_unit_12, _in0=_pt_tmp_119, _in1=_pt_tmp_122)[
            "out"
        ]
    )
    del _pt_tmp_340
    ...
    _pt_tmp_337 = (0.5 + 0j) * _pt_tmp_338
    ...
    _pt_tmp_334 = (
        ...
        if actx.supports_nonscalar_broadcasting
        else actx.call_loopy(_pt_t_unit_12, _in0=_pt_tmp_135, _in1=_pt_tmp_335)[
            "out"
        ]
    )
    ...
    del _pt_tmp_135
    _pt_tmp_330 = (0.5 + 0j) * _pt_tmp_331
    del _pt_tmp_332, _pt_tmp_334
    _pt_tmp_329 = (
        _pt_tmp_330[_pt_tmp_136, _pt_tmp_82]
        if actx.permits_advanced_indexing
        else actx.call_loopy(
            _pt_t_unit_13, in_0=_pt_tmp_330, in_1=_pt_tmp_136, in_2=_pt_tmp_82
        )["out"]
    )
    del _pt_tmp_331
    _pt_tmp_328 = (
        ...
        if actx.supports_nonscalar_broadcasting
        else actx.call_loopy(_pt_t_unit_8, _in0=_pt_tmp_89, _in1=_pt_tmp_329)["out"]
    )
    del _pt_tmp_330
    ...
    _pt_tmp_327 = 0j + _pt_tmp_328
    _pt_tmp_326 = 0j + _pt_tmp_327
    del _pt_tmp_328
    ...
    del _pt_tmp_324
    _pt_tmp_305 = actx.np.reshape(_pt_tmp_306, (4, 162, 6))
    ...
    _pt_tmp_294 = _pt_tmp_295 / np.complex128(1 + 0j)
    ...
    del _pt_tmp_146
    _pt_tmp_347 = (1 + 0j) * _pt_tmp_348
    _pt_tmp_346 = 0j + _pt_tmp_347
    del _pt_tmp_348
    ...
    _pt_tmp_362 = (
        ...
        if actx.supports_nonscalar_broadcasting
        else actx.call_loopy(_pt_t_unit_5, _in0=_pt_tmp_47, _in1=_pt_tmp_261)["out"]
    )
    del _pt_tmp_345
    _pt_tmp_361 = 0j + _pt_tmp_362
    del _pt_tmp_261, _pt_tmp_47
    _pt_tmp_363 = (
        _pt_tmp_54 * _pt_tmp_316
        if actx.supports_nonscalar_broadcasting
        else actx.call_loopy(_pt_t_unit_5, _in0=_pt_tmp_54, _in1=_pt_tmp_316)["out"]
    )
    del _pt_tmp_362
    _pt_tmp_360 = _pt_tmp_361 + _pt_tmp_363
    del _pt_tmp_316, _pt_tmp_54
    _pt_tmp_359 = (0.5 + 0j) * _pt_tmp_360
    del _pt_tmp_361, _pt_tmp_363
    _pt_tmp_358 = (
        _pt_tmp_359[_pt_tmp_81, _pt_tmp_82]
        if actx.permits_advanced_indexing
        else actx.call_loopy(
            _pt_t_unit_7, in_0=_pt_tmp_359, in_1=_pt_tmp_81, in_2=_pt_tmp_82
        )["out"]
    )
    del _pt_tmp_360
    _pt_tmp_357 = (
        ...
        if actx.supports_nonscalar_broadcasting
        else actx.call_loopy(_pt_t_unit_8, _in0=_pt_tmp_25, _in1=_pt_tmp_358)["out"]
    )
    ...
    _pt_tmp_356 = 0j + _pt_tmp_357
    _pt_tmp_355 = 0j + _pt_tmp_356
    del _pt_tmp_357
    _pt_tmp_374 = (
    ...
    del _pt_tmp_356
    _pt_tmp_373 = 0j + _pt_tmp_374
    del _pt_tmp_107, _pt_tmp_287
    _pt_tmp_375 = (
        _pt_tmp_113 * _pt_tmp_335
        if actx.supports_nonscalar_broadcasting
        else actx.call_loopy(_pt_t_unit_12, _in0=_pt_tmp_113, _in1=_pt_tmp_335)[
            "out"
        ]
    )
    del _pt_tmp_374
    ...
    _pt_tmp_371 = (0.5 + 0j) * _pt_tmp_372
    del _pt_tmp_373, _pt_tmp_375
    _pt_tmp_370 = (
        _pt_tmp_371[_pt_tmp_136, _pt_tmp_82]
        if actx.permits_advanced_indexing
        else actx.call_loopy(
            _pt_t_unit_13, in_0=_pt_tmp_371, in_1=_pt_tmp_136, in_2=_pt_tmp_82
        )["out"]
    )
    del _pt_tmp_372
    _pt_tmp_369 = (
        ...
        if actx.supports_nonscalar_broadcasting
        else actx.call_loopy(_pt_t_unit_8, _in0=_pt_tmp_89, _in1=_pt_tmp_370)["out"]
    )
    ...
    _pt_tmp_368 = 0j + _pt_tmp_369
    _pt_tmp_367 = 0j + _pt_tmp_368
    del _pt_tmp_369
    ...
    _pt_tmp_353 = actx.np.reshape(_pt_tmp_354, (4, 162, 6))
    ...
    _pt_tmp_342 = _pt_tmp_343 / np.complex128(1 + 0j)
...
class RHSInvoker:
    ...
    def npzfile(self):
        ...
        kw_to_ary = np.load(
            os.path.join(
                get_actx_dgfem_suite_path(), "suite/tiny_maxwell_3D_P2/literals.npz"
            )
        )
        return constantdict(
            {
    ...
    def _get_output_template(self):
        ...
        fpath = os.path.join(
            get_actx_dgfem_suite_path(), "suite/tiny_maxwell_3D_P2/ref_outputs.pkl"
        )
